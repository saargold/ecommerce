...
import {Box,Flex,Circle,Badge,Image,Icon,Stack,Tooltip,Button,Text,useColorModeValue, HStack} from '@chakra-ui/react'
...
export default function ProductCard({product}) {
  return (
    ...
    {product.isNew && <Circle size='10px' position='a' top={2} right={2} bg='green.300'/>}
    {product.stock <=0  && <Circle size='10px' position='a' top={2} right={2} bg='red.300'/>}
