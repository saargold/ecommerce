...
import {Link as ReactLinkn} from 'react-router-dom'
...
const NavLink =({path,children}) =>(
    <Link as={ReactLinkn} to={path} px={2} py={2} rounded="md" _hover={{textDecoration: 'none' , bg :useColorModeValue('gray.200','gray.200')}}>
    {children}
</Link>
...
<Box bg={useColorModeValue('gray.100','gray.900')}  px={4}>
    <Flex h={16} alignItems='center' justifyContent='space-between'>
        ...
        <Button as={ReactLinkn} to='/login' p={2} fontSize="sm" fontWeight={400} variant='link'>Sign In</Button>
        <Button as={ReactLinkn} to='/registration' m={2} display={{base:'none',md:'inline-flex'}} fontSize="sm" fontWeight={600} _hover ={{bg: 'orange.400'}} bg='orange.500' color="white" >Sign Up</Button>
        </Flex>
